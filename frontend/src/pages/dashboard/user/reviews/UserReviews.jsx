      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 mt-8">
        {reviews &&
          reviews.map((review, index) => (
            <div
              key={index}
              className="bg-white shadow-md rounded-lg p-4 border-gray-200 cursor-pointer hover:scale-105 transition-all duration-200 mx-2"
            >
        ...
        <div
          ...
          className="bg-gray-100 text-black flex items-center justify-center rounded-lg p-6 border cursor-pointer hover:bg-primary hover:text-white transition-all duration-200 gap-8 mt-4"
        >
          <span>+</span>
          <p>Add New Reviews</p>
        </div>
